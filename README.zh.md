...
[⬇️ 下载 v0.0.1](https://github.com/yangyiqu00000/freemodel/releases/latest) · [🐛 反馈问题](https://github.com/yangyiqu00000/freemodel/issues)
...
1. 前往 [**Releases → v0.0.1**](https://github.com/yangyiqu00000/freemodel/releases/latest)
2. 下载 `FreeModelMenuBar-0.0.1.dmg`
...
| 路由 | Node.js (`node:http` / `node:https`) | 零依赖,~300 行 |
